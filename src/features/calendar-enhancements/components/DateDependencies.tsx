...
import { DateDependency, DependencyChain, DateViolation } from '../types';
...
export function DateDependencies({
  ...
  const [selectedType, setSelectedType] =
    useState<(typeof DEPENDENCY_TYPES)[number]['value']>('finish_to_start');
  const [violations, setViolations] = useState<DateViolation[]>([]);
  ...
  // Detect violations
  const detectViolations = useCallback((): DateViolation[] => {
