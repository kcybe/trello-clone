// Socket.IO server-only code
// This module should ONLY be imported in server-side contexts (API routes, standalone server)
// It should NOT be imported by client components
import { Server as HttpServer } from 'http';
import { Server, Socket } from 'socket.io';

// Socket event types (shared with client)
